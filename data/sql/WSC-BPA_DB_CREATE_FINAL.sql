...
VALUES ('7', '2', '6', '11', 'Rogers Intramural Champions 2016', 1);

INSERT INTO `williams`.`orders` (cusID, invID, empID, typID, Details, Complete)
VALUES ('10', '1', '10', '10', 'Stencil Logo Flaming Basketball Through Hoop. Phrase "En Fuego" below logo.', 1);

INSERT INTO `williams`.`orders` (cusID, invID, empID, typID, Details, Complete)
VALUES ('2', '3', '1', '11', 'Top Plate: Congratulations; Font: Castellar; Bottom Plate: Top Sales Q4, 2015; Font: Castellar; Picture: Framed Dollar Bill.', 1);

INSERT INTO `williams`.`orders` (cusID, invID, empID, typID, Details, Complete)
VALUES ('1', '2', '9', '10', 'Chevrolet Bowtie: Front; Phrase: Nothin Runs Like A Chevy: Below.', 1);
...
--     IN `Details` VARCHAR(500) IN `Complete` BIT(1))
--     BEGIN
-- 	INSERT INTO `order`(`cusID`,`invID`,`empID`,`typID`, `Details`,`Complete`)
-- 	VALUES (`cusID`,`invID`,`empID`,`typID`,`Details`,`Complete`);
--     END$$
-- DELIMITER ;
/*--------------------------------------------------------------------------------------------------------------------------------------------------*/
...
-- DELIMITER $$
-- CREATE
--     PROCEDURE `williams`.`inventoryInsert`(IN `typID` INT(2), IN `Available` BIT(1))
--     BEGIN
-- 	INSERT INTO `inventory`(`typID`, `Available`)
-- 	VALUES (`typID`, `Available`);
--     END$$
-- DELIMITER ;
/*---------------------------------------------------------------------------------------------------------------------------------------------------*/
...
-- DELIMITER $$
-- CREATE
--     PROCEDURE `williams`.`credentialsInsert`(IN `Password`VARCHAR(25), IN `Time` VARCHAR(30), IN `ActiveIND` BIT(1))
--     BEGIN
-- 	INSERT INTO `credentials`(`Password`, `Time`, `LoginAttempts`, `ActiveIND`)
-- 	VALUES(`Password`, `Time`, `LoginAttempts`, `ActiveIND`);
--     END$$
-- DELIMITER ;
/*----------------------------------------------------------------------------------------------------------------------------------------------------*/
